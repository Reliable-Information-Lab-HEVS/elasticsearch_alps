...
CSV_FILE="${CSV_FILE:-/capstor/scratch/cscs/inesaltemir/scripts/search_queries/chemicals/chemicals_en.csv}"
# /capstor/scratch/cscs/inesaltemir/scripts/search_queries/WeaponizedWords/ww_en.csv

SCRIPT_PATH="${SCRIPT_PATH:-/capstor/scratch/cscs/inesaltemir/scripts/search/puto_search.sh}"
