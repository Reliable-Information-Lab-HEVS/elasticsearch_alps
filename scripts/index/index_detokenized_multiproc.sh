...
#SBATCH --output=/capstor/scratch/cscs/inesaltemir/INDEXING_TOKENIZED/swissai-fineweb-2-quality_33-filterrobots-merge_other-high/output/indexing_%j.out
#SBATCH --error=/capstor/scratch/cscs/inesaltemir/INDEXING_TOKENIZED/swissai-fineweb-2-quality_33-filterrobots-merge_other-high/err/indexing_%j.err
