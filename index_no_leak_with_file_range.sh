...
#SBATCH --output=/capstor/scratch/cscs/inesaltemir/fineweb_indexing/test_scale/output/indexing_%j.out
#SBATCH --error=/capstor/scratch/cscs/inesaltemir/fineweb_indexing/test_scale/err/indexing_%j.err
...
FILE_RANGE_END="${FILE_RANGE_END:-20}"         # Ending file index
